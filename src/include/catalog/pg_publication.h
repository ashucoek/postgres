 ...
 * GetPublicationIncludedRelations(), which allows callers to specify which
...
extern bool is_relation_excluded(Oid relid, Oid pubid);
extern bool publication_has_any_exception(Oid pubid);
